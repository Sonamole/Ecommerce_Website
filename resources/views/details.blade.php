                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        ...
                                        @if ($product->images)
                                          @php   //Blade directive that allows you to write plain PHP code within a Blade template.
                                             $images=explode(',',$product->images) // Split the comma-separated image URLs into an array
                                          @endphp
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    ${{ $product->sale_price }}
                                    <del>${{ $product->regular_price }}</del><span> <!-- Strike through the regular price -->
                                        {{-- Calculate the discount percentage and display it --}}
                                        {{round((($product->regular_price-$product->sale_price)/$product->regular_price )*100)}}off</span></h3>
                                    @else
                                     <!-- If there's no sale price, display the regular price -->
