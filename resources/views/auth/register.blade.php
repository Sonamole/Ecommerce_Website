               ...
               @csrf
                ...
                <div class="input">
                    ...
                    <input type="email" id="emailname" class="block mt-1 w-full" type="email" name="email"
                        ...
                        @error('email')<span class="text-danger mt3">{{ $message }}</span>
                ...
                <div class="input">
                    ...
                    <input type="password" id="pass" class="block mt-1 w-full" name="password" required=""
                        ...
                        {{-- The error message for the "password" field would be whatever message you have specified in your Laravel validation rules.
                        In Laravel, you typically define validation rules in your controller or form request class. --}}
                ...
                <div class="input">
                    ...
                    <input type="password" id="compass" class="block mt-1 w-full" name="password_confirmation"
                        ...
                        {{-- @error('password_confirmation')<span class="text-danger mt3">{{ $message }}</span>
